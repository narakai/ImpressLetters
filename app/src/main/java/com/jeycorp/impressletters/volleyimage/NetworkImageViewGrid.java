...
public class NetworkImageViewGrid extends ImageView{
	...
	public NetworkImageViewGrid(Context context) {
		this(context, null);
		mContext = context;
	}

	public NetworkImageViewGrid(Context context, AttributeSet attrs) {
...
//                        	if(width*1.5<height){
//                        		b = Bitmap.createBitmap(response.getBitmap(), 0, 0, width, height/2);
//                        		setImageBitmap(b);
//                        	}else{
...
//			AppImgResize loadingResize = new AppImgResize(mContext,
//					R.drawable.preloaders_list);
//			if (height > loadingResize.getHeight()) {
//				height = loadingResize.getHeight();
//			}
