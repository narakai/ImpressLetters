...
public class GoodsWriteFragment extends Fragment {
    ...
    public GoodsWriteFragment() {
    }

    public GoodsWriteFragment(Context context) {
...
//        setAlpha_bottomView();
    ...
    public void getHeaderView(String weatherWord){
        WeatherHeaderView weatherHeaderView = new WeatherHeaderView(activity,this,header,dustGrade,dustValue);
